...
namespace Cinemas.API.Controllers
{
    ...
    public class FilmRoomsController : ApiController
    {
        ...
        public IEnumerable<FilmRoom> GetFilmRoom(int RId)
        {
            return _filmroomService.GetFilmRoom(RId);
        }

        public IEnumerable<FilmRoom> GetFilmRoomByRoom(int RId)
        {
            return _filmroomService.GetFilmRoomByRoom(RId);
        }
    }
}
